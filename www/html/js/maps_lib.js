(function (window, undefined) {
    var MapsLib = function (options) {
        ...
        this.fusionTableId1 = options.fusionTableId1 || "",
        this.fusionTableId2 = options.fusionTableId2 || "",
        ...
        this.defaultZoom = options.defaultZoom || 14; 
    ...
    */
    ...
    MapsLib.prototype.submitSearch = function (fusionTableId, whereClause, map) {
        var self = this;
        ...
        //self.fusionTable = self.searchrecords; // This line seems useless
    ...
    MapsLib.prototype.doSearch = function () {
        ...
        self.whereClause = self.locationColumn + " not equal to ''";
        // Days
        var validSundayColumn = "'sun'";
        var validMondayColumn = "'mon'";
        var validTuesdayColumn = "'tues'";
        var validWednesdayColumn = "'wed'";
        var validThursdayColumn = "'thurs'";
        var validFridayColumn = "'fri'";
        var validSaturdayColumn = "'sat'";
        ...
        self.getgeoCondition(address, function (geoCondition) {
            self.whereClause += geoCondition;
            self.submitSearch(self.fusionTableId2, self.whereClause, self.map);
        });
    };
    ...
    MapsLib.prototype.getInfo = function (callback) {
        var self = this;
        jQuery.ajax({
            url: 'https://www.googleapis.com/fusiontables/v2/tables/' + self.fusionTableId1 + '?key=' + self.googleApiKey,
            dataType: 'json'
    ...
    */
    ...
    MapsLib.prototype.query = function (query_opts, callback) {
        ...
        queryStr.push(" FROM " + self.fusionTableId2);
